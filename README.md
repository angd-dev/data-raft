...
let package = Package(
    name: "YourProject",
    dependencies: [
        .package(url: "https://github.com/angd-dev/data-raft.git", from: "0.1.0")
    ],
    targets: [
        .target(
            name: "YourTarget",
...
For more information and usage examples, see the [documentation](https://docs.angd.dev/?package=data-raft&version=0.1.0). You can also explore related projects like [DataLiteCore](https://github.com/angd-dev/data-lite-core) and [DataLiteCoder](https://github.com/angd-dev/data-lite-coder).
